            ...
            <div class="relative overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                ...
                <thead>
                    <tr>
                      ...
                      <th scope="col" class="connect text-center" v-tooltip:top.tooltip="'Relay connection status'">
                        <code class="text-xs block">Connect</code>
                        <!-- 🔌 -->
                      </th>
                      <th scope="col" class="read text-center" v-tooltip:top.tooltip="'Relay read status'">
                        <code class="text-xs block">Read</code>
                        <!-- 👁️‍🗨️ -->
                      </th>
                      <th scope="col" class="write text-center" v-tooltip:top.tooltip="'Relay write status'">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr 
                      ...
                      <td class="w-12 verified text-center">
...
<!--                  .indicator {
                      ...
                      <td class="w-16 content-center text-center" :key="generateKey(relay, 'check.connect')">
                        <span class="m-auto block" :class="getCheckIndicator(relay, 'connect')">&nbsp;</span>
                      </td>

                      <td class="w-16 content-center text-center" :key="generateKey(relay, 'check.read')">
                        <span class="m-auto block" :class="getCheckIndicator(relay, 'read')">&nbsp;</span>
                      </td>

                      <td class="w-16 content-center text-center" :key="generateKey(relay, 'check.write')">
