// To parse this data:
//
//   import { Convert, Serialize } from "./file";
//
//   const serialize = Convert.toSerialize(json);
//
...
export class Convert {
    public static toSerialize(json: string): Serialize {
        return cast(JSON.parse(json), r("Serialize"));
    }

    public static serializeToJson(value: Serialize): string {
        return JSON.stringify(uncast(value, r("Serialize")), null, 2);
    }
}
