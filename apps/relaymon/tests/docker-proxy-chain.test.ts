...
describe("Docker Proxy Chain Tests", () => {
  it("should diagnose clearnet websocket connection through proxy chain", async () => {
  ...
  it("should diagnose Tor websocket connection through proxy chain", async () => {
  ...
  it("should test component connectivity", async () => {
  ...
  it("should test .onion DNS resolution through the proxy chain", async () => {
  ...
  it("should test if Tor SOCKS connections are being rejected", async () => {
