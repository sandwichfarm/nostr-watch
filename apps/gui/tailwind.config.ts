    ...
    plugins: [
		...
		plugin(({ addComponents }) => {
			const gradients = {
			  ...
			  '.gradient-purple-500': {
				'@apply bg-gradient-to-br from-purple-500/5 to-purple-500/30 transition-all duration-500 bg-size-200 bg-pos-0 hover:bg-pos-100': {},
			  },
			  '.gradient-purple-600': {
			  ...
			  '.gradient-purple-900': {
				'@apply bg-gradient-to-br from-purple-900/20 to-purple-900/30 transition-all duration-500 bg-size-200 bg-pos-0 hover:bg-pos-100': {},
			  },
