...
// ../../node_modules/.pnpm/modern-isomorphic-ws@1.0.5_ws@8.18.0_bufferutil@4.0.8_utf-8-validate@5.0.10_/node_modules/modern-isomorphic-ws/browser.js
var browser_default = WebSocket;
...
var WebSocketWrapper = class {
  ...
  on(key, fn) {
    ...
    this.ws?.addEventListener(key, wrappedFn);
  }
  off() {
  ...
  async connect() {
    ...
    this.ws = new browser_default(this.relay, this.options);
  ...
  get CONNECTED() {
    return this.ws?.readyState === browser_default.OPEN;
  }
  get CONNECTING() {
    return this.ws?.readyState === browser_default.CONNECTING;
  }
  get CLOSING() {
    return this.ws?.readyState === browser_default.CLOSING;
  }
  get CLOSED() {
    return this.ws?.readyState === browser_default.CLOSED;
  }
  get BUSY() {
