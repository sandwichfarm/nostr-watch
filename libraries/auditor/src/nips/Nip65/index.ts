...
import type { RelayClosedMessage, RelayEoseMessage, RelayEventMessage, RelayNoticeMessage, RelayOkMessage, Note } from '#src/nips/Nip01/interfaces/index.js';
...
export class Nip65 extends Suite implements ISuite {
  ...
  public readonly jsonValidators: Record<string, SchemaValidator<any>> = {
    EVENT: new SchemaValidator<Note>(kind10002Schema),
  };
