...
- [ ] **LIB-01**: README.md for libraries/nocap following styleguide (adapter-based relay capability discovery)
- [ ] **LIB-02**: README.md for libraries/route66 following styleguide (relay aggregation + state management)
