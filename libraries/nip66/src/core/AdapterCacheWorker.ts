...
import { AdapterWorker, WorkerOptions } from "./AdapterWorker"
...
export interface AdapterCacheWorkerResult extends AdapterWorkerCommand {
  type: "events" | "event" | "eventsBuffer";
}
