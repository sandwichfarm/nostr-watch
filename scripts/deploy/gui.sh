...
echo "BUILDING @nostrwatch/route66"
yarn workspace @nostrwatch/route66 build

echo "BUILDING @nostrwatch/route66-wsadapter-nostrtools"
yarn workspace @nostrwatch/route66-wsadapter-nostrtools build

echo "BUILDING @nostrwatch/route66-cacheadapter-nostrsqlite"
yarn workspace @nostrwatch/route66-cacheadapter-nostrsqlite build
