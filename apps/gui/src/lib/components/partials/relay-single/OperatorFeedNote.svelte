...
<section 
    ...
    class="note px-8 py-5 rounded-lg bg-black/5 dark:bg-black/5 text-md block mb-3" 
    use:observeViewport
    ...
    <div class="content text-black/55 dark:text-black/55 text-xl my-6 overflow-hidden overflow-ellipsis">
        {@html $content}
    </div>
