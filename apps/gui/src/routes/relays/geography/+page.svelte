<script lang="ts">
	...
	import builtInTableConfig from '$lib/config/dataTable/geocodes.js'
	import { geoRows as data } from '$lib/stores/geocodes.js';
    ...
    const loadComponents = async () => {
		const imports = [
			import('$lib/components/data-view/table/DataTable.svelte'),
		];
